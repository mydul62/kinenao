...
async function main() {
    ...
    const makeDesc = (title, quote, bullets) => `
<p>${title}</p>
<p>"${quote}"</p>
...
`;
    ...
    const productsData = [
        // --- Category: শাড়ি ---
        {
            ...
            description: makeDesc("এক্সক্লুসিভ জর্জেট এম্ব্রয়ডারি শাড়ি 🥻 ✨", "যেকোনো পার্টি বা উৎসবে আপনাকে দেবে অনন্য ও মার্জিত লুক। হাই-কোয়ালিটি জর্জেট ফেব্রিক ও গর্জিয়াস কারুকাজ।", [
        ...
        },
        {
            ...
            description: makeDesc("হাতে বোনা তাঁতের জামদানি শাড়ি 🌸", "ঐতিহ্যবাহী জামদানি নকশায় তৈরি ১০০% কটন সুতি শাড়ি। ক্যাজুয়াল পরার জন্য সেরা পছন্দ।", [
        ...
        // --- Category: থ্রি-পিস ---
        {
            ...
            description: makeDesc("ডিজাইনার কটন থ্রি-পিস ৩-পিস কালেকশন 👗", "নান্দনিক ডিজিটাল প্রিন্ট ও সুতার নিখুঁত এমব্রয়ডারি কাজের আকর্ষণীয় থ্রি-পিস।", [
        ...
        },
        {
            ...
            description: makeDesc("গর্জিয়াস ভেলভেট পার্টি থ্রি-পিস 💎", "শীতের পার্টি ও ওয়েডিং সিজনের জন্য রাজকীয় লাক্সারি ভেলভেট ড্রেস।", [
        ...
        // --- Category: বাচ্চাদের খেলনা ও বই ---
        {
            ...
            description: makeDesc("বাচ্চাদের ওয়াটার ম্যাজিক ড্রয়িং বুক 🎨 📖", "পাস ও পানি দিয়ে আঁকলে রঙ ভেসে ওঠে, শুকিয়ে গেলে আবার আঁকা যায়! বারবার ব্যবহারযোগ্য।", [
        ...
        },
        {
            ...
            description: makeDesc("ড্যান্সিং ও টকিং ক্যাকটাস খেলনা 🌵 🎵", "কথা বললে হুবহু অনুকরণ করে হাসায় এবং গান গেয়ে নেচে বাচ্চাদের আনন্দ দেয়!", [
        ...
        // --- Category: মেকআপ আইটেম ---
        {
            ...
            description: makeDesc("Metal Mosquito Coil Holder 🦟 🦟", "মশার উপদ্রব এখন চারিদিকেই, তাই নিরাপদে কয়েল ব্যবহার করতে আজই নিন Mosquito Coil Holder যাতে নেই কোথাও আগুন লাগার ভয়, ছাই ছড়াবে না ঘরের কোথাও", [
        ...
        },
        {
            ...
            description: makeDesc("১২ পিস লং-লাস্টিং ম্যাট লিপস্টিক সেট 💄 ✨", "স্মাজপ্রুফ ও ওয়াটারপ্রুফ ফর্মুলা যা সারাদিন ঠোঁটে সুন্দর কালার ধরে রাখে।", [
        ...
        },
        {
            ...
            description: makeDesc("কমপ্লিট মেকআপ কম্বো প্যাক 💅 💄", "আইশ্যাডো প্যালেন্ট, ব্লাশ, লিপস্টিক ও মেকআপ ব্রাশের অল-ইন-ওয়ান প্রফেশনাল সেট।", [
        ...
        // --- Category: হোম ডেকোর ---
        {
            ...
            description: makeDesc("হাতে বোনা ঝুলন্ত দোলনা 🏡", "বাসা, বারান্দা কিংবা গার্ডেনে ঝুলানোর জন্য আরামদায়ক হ্যান্ডমেড কটন দোলনা।", [
        ...
        },
        {
            ...
            description: makeDesc("ভিআইপি ফোল্ডিং মশারি টেন্ট ⛺", "সহজেই ভাঁজ করে বহনযোগ্য প্রিমিয়াম কোয়ালিটি মশারি।", [
        ...
        // --- Category: ব্যাগ ও পার্স ---
        {
            ...
            description: makeDesc("প্রিমিয়াম পিইউ লেদার হ্যান্ডব্যাগ 👜", "অফিস, শপিং ও পার্টিতে ব্যবহারের জন্য মার্জিত ডিজাইনের লেদার ব্যাগ।", [
        ...
        // --- Category: ইলেকট্রনিক্স ও গ্যাজেট ---
        {
            ...
            description: makeDesc("রিচার্জেবল ইলেকট্রিক মশা মারার র‍্যাকেট ⚡", "হাই ভোল্টেজ ব্যাকলাইট ইউভি লাইট সহ কার্যকর রিচার্জেবল র‍্যাকেট।", [
        ...
        },
        {
            ...
            description: makeDesc("পোর্টেবল ওয়ারলেস স্পিকার 🔊", "হাই বাস ক্রিস্টাল ক্লিয়ার সাউন্ড সহ মিনি ব্লুটুথ স্পিকার।", [
        ...
        // --- Category: হেলথ ও পার্সোনাল কেয়ার ---
        {
            ...
            description: makeDesc("Electric Body Massager 💆‍♂️", "ঘাড়, কাঁধ এবং শরীরের মাংসপেশীর ক্লান্তি দূর করতে কার্যকরী হ্যান্ডহেল্ড ম্যাসাজার।", [
        ...
        },
        {
            ...
            description: makeDesc("পোর্টেবল মেস নেবুলাইজার 🩺", "বাচ্চা ও বড়দের শ্বাসকষ্ট উপশমে নিঃশব্দ ও পোর্টেবল নেবুলাইজার মেশিন।", [
                "পকেটে বহনযোগ্য সাইজ।",
        ...
        // --- Category: জুয়েলারি ও এক্সেসরিজ ---
        {
            ...
            description: makeDesc("এক্সক্লুসিভ গয়না সেট 💍 ✨", "শাড়ি বা থ্রি-পিসের সাথে পরার জন্য গর্জিয়াস গোল্ড প্লেটেড নেকলেস ও কানের দুল সেট।", [
        ...
        // --- Category: ঘড়ি ও ফ্যাশন ---
        {
            ...
            description: makeDesc("প্রিমিয়াম স্টেইনলেস স্টিল ঘড়ি ⌚ ✨", "ওয়াটারপ্রুফ ডায়াল ও এলিগ্যান্ট ডায়মন্ড কাট ফিনিশিং ঘড়ি।", [
