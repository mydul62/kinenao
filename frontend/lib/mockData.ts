...
export const mockCategories: Category[] = [
  ...
  {
    id: "cat-fruits-vegetables",
    name: "Fruits & Vegetables (ফল ও শাকসবজি)",
    slug: "fruits-vegetables",
    imageUrl: "https://images.unsplash.com/photo-1610832958506-aa56368176cf?q=80&w=800&auto=format&fit=crop",
    description: "১০০% ফরমালিনমুক্ত তাজা দেশি-বিদেশি ফলমূল ও অর্গানিক শাকসবজি সরাসরি বাগান থেকে",
    itemCount: 76,
    childCategories: [
      { id: "sub-fresh-fruits", name: "Fresh Fruits", slug: "fresh-fruits", parentId: "cat-fruits-vegetables", itemCount: 28, imageUrl: "https://images.unsplash.com/photo-1619566636858-adf3ef46400b?q=80&w=600&auto=format&fit=crop" },
      { id: "sub-fresh-veg", name: "Fresh Vegetables", slug: "fresh-veg", parentId: "cat-fruits-vegetables", itemCount: 24, imageUrl: "https://images.unsplash.com/photo-1540420773420-3366772f4999?q=80&w=600&auto=format&fit=crop" },
      { id: "sub-organic-salad", name: "Organic Salad & Herbs", slug: "organic-salad", parentId: "cat-fruits-vegetables", itemCount: 14, imageUrl: "https://images.unsplash.com/photo-1512621776951-a57141f2eefd?q=80&w=600&auto=format&fit=crop" },
      { id: "sub-dry-fruits", name: "Dry Fruits & Nuts", slug: "dry-fruits", parentId: "cat-fruits-vegetables", itemCount: 10, imageUrl: "https://images.unsplash.com/photo-1596040033229-a9821ebd058d?q=80&w=600&auto=format&fit=crop" },
    ],
  },
  {
    id: "cat-dairy",
    ...
    description: "খাঁটি দেশি গাভীর দুধ, মাখন, পনির ও ফার্ম ফ্রেশ লাল ডিম",
    itemCount: 38,
    childCategories: [
      { id: "sub-milk", name: "Fresh Milk", slug: "fresh-milk", parentId: "cat-dairy", itemCount: 12, imageUrl: "https://images.unsplash.com/photo-1550583724-b2692b85b150?q=80&w=600&auto=format&fit=crop" },
      { id: "sub-eggs", name: "Farm Eggs", slug: "farm-eggs", parentId: "cat-dairy", itemCount: 10, imageUrl: "https://images.unsplash.com/photo-1582722872445-44dc5f7e3c8f?q=80&w=600&auto=format&fit=crop" },
      { id: "sub-cheese", name: "Cheese & Butter", slug: "cheese-butter", parentId: "cat-dairy", itemCount: 16, imageUrl: "https://images.unsplash.com/photo-1486297678162-eb2a19b0a32d?q=80&w=600&auto=format&fit=crop" },
    ],
  },
  {
    id: "cat-meat-fish",
    name: "Meat & Fish (মাংস ও মাছ)",
    slug: "meat-fish",
    imageUrl: "https://images.unsplash.com/photo-1607623814075-e51df1bdc82f?q=80&w=800&auto=format&fit=crop",
    description: "তাজা নদীর ইলিশ, রুই, দেশি মুরগি ও প্রিমিয়াম খাসির মাংস",
    itemCount: 45,
    childCategories: [
      { id: "sub-fresh-fish", name: "River & Sea Fish", slug: "fresh-fish", parentId: "cat-meat-fish", itemCount: 22, imageUrl: "https://images.unsplash.com/photo-1534483509719-3feaee7c30da?q=80&w=600&auto=format&fit=crop" },
      { id: "sub-chicken-beef", name: "Fresh Meat & Poultry", slug: "chicken-beef", parentId: "cat-meat-fish", itemCount: 23, imageUrl: "https://images.unsplash.com/photo-1607623814075-e51df1bdc82f?q=80&w=600&auto=format&fit=crop" },
    ],
  },
];
